...
export default function Edit({ employee_salary, employees }) {
    const { data, setData, post, processing, errors } = useForm({
        employee_id: employee_salary.employee_id || "",
        month: employee_salary.month || new Date().getMonth() + 1,
        year: employee_salary.year || currentYear,
        basic_salary: employee_salary.basic_salary || "",
        bonus: employee_salary.bonus || "",
        bpjs: employee_salary.bpjs || "",
        jp: employee_salary.jp || "",
        loan: employee_salary.loan || "",
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route("employee-salary.update", employee_salary.id));
    };
